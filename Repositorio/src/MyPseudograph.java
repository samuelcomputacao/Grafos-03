...
public class MyPseudograph {
	// Grafo com arestas paralelas e loops. Arestas possuem label.
	...
	public static void main(String[] args) {
	    ...
	    Pseudograph<DefaultVertex, RelationshipEdge> graphgml = new Pseudograph<>(RelationshipEdge.class);    
 	    try {
	        gmlImporter.importGraph(graphgml, ImportGraph.readFile("C:\\Users\\patricia\\Dropbox\\workspace\\Graph Theory\\src\\pseudograph-Aula02.gml"));
	    ...
	    System.out.println("\nGrafo permite loops? " + graphgml.isAllowingLoops());
	    System.out.println("Grafo permite arestas paralelas? " + graphgml.isAllowingMultipleEdges());
	    System.out.println("Grafo é direcionado? " + graphgml.isDirected());
	    System.out.println("Grafo é ponderado? " + graphgml.isWeighted());
